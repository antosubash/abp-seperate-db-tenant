...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c1fd5b5b-da12-4769-bc45-0144ade39e81
```

> `c1fd5b5b-da12-4769-bc45-0144ade39e81` is the password of the certificate, you can change it to any password you want.
